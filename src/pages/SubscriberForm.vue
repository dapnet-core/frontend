  ...
  <q-page padding>
    ...
    >
      <template #section-default>
        ...
        >
        <template v-slot:prepend><q-icon name="mdi-account-multiple" /></template>
        </q-select>
        <q-select
          v-model="data.owners"
        ...
        >
          ...
          <template #no-option="scope"><div class="q-pa">No owners found for query "{{scope.inputValue}}"</div></template>
        </q-select>
      </div>
      </template>
      <template #section-pagers>
        <q-list bordered separator class="q-mb-sm">
          ...
          <div class="flex q-px-xs items-center">
            ...
            <q-btn dense icon="mdi-delete-outline" color="red" size="0.75em"></q-btn>
          </div>
          </q-item>
          <q-item class="q-px-xs">
            <q-btn class="full-width" label="Add new pager" color="green"></q-btn>
          </q-item>
        </q-list>
      </template>
